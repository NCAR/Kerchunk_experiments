...
def test_combine():
    create_kerchunk.process_kerchunk_combine(directory='/gpfs/csfs1/collections/rda/data/d559000/wy1981/198102/', output_directory='.', extensions=[], regex=r"^.*wrf2d.*-02.*$", dry_run=False)
